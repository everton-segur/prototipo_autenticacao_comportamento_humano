...
model_name = 'saved_model_decision_tree.pkl'
...
def __fit_model():
    ...
    x_penguin_train, x_penguin_test, y_penguin_train, y_penguin_test = train_test_split(penguins_X, penguins_y,
                                                                                        ...
                                                                                        stratify=penguins_y)
    multi_model = DecisionTreeClassifier(criterion="entropy", max_depth=200).fit(x_penguin_train,
                                                                                 y_penguin_train)
...
def get_result_for_decision_tree(args):
