...
public class IAAuthenticatorFactory implements AuthenticatorFactory {

    public static final String ID = "iaauthenticator";

    private static final Authenticator AUTHENTICATOR_INSTANCE = new IAAuthenticator();
